"""V8: Paris text + market odds + DeBERTa. Men's only."""
...
def main():
    parser = argparse.ArgumentParser(description="V8 DeBERTa: Paris text + market odds")
    ...
    parser.add_argument("--model-path", default=None, help=f"Model path (default: {config.MODEL_DIR}/deberta-v8)")
    ...
    model_path = args.model_path or os.path.join(config.MODEL_DIR, "deberta-v8")
